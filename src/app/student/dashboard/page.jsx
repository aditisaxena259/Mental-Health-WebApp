...
function StudentDashboardInner() {
  ...
  const handleNewComplaintSubmit = async (e) => {
    ...
    try {
      ...
      setNewComplaint({ title: "", type: "", description: "" });
      // refresh list
              ...
              <div className="p-4 mt-14">
                ...
                <nav className="space-y-1">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-3 w-full px-4 py-3 text-left text-sm rounded-md text-gray-700 hover:bg-gray-100"
                  >
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      (window.location.href = "mailto:warden@university.edu")
                    }
                  >
                    Contact Warden
                  </Button>
                      ...
                      <div className="grid gap-4 py-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500">
                            Upload images or documents related to your complaint
                            (max 5MB)
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      {filteredComplaints.map((complaint, index) => (
                        <div
                          ...
                          onClick={() =>
                            complaint?.id && handleViewComplaint(complaint.id)
                          }
                        >
                  ...
                  <div className="space-y-4">
                    {filteredComplaints.filter((c) => c.status === "resolved")
                      ...
                      filteredComplaints
                        ...
                        .map((complaint, index) => (
                          <div
                            key={complaint.id || `resolved-${index}`}
                            className="bg-white rounded-lg border border-gray-200 overflow-hidden transition-shadow hover:shadow-md"
                            onClick={() =>
                              complaint?.id && handleViewComplaint(complaint.id)
                            }
